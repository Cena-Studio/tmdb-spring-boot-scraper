...
public class EpisodeService {
    ...
    public EpisodeServiceDTO getEpisodeInfo(String title, int year, int seasonSize, int season, int episodeSize, int episode) {
        
        int tvSeriesId = 70626;
        EpisodeDetailsResponseBody episodeDetailsResponseBody = TMDbAPIAccessor.getEpisodeDetails(tvSeriesId, season, episode);
